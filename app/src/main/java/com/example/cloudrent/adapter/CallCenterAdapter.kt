...
class CallCenterAdapter(private val context: Context, private val quest: List<QuestVariabel>, val listener: (QuestVariabel) -> Unit) :
    RecyclerView.Adapter<CallCenterAdapter.ListViewHolder>() {
    class ListViewHolder(view: View) : RecyclerView.ViewHolder(view)
    {
        val quest_text = view.findViewById<TextView>(R.id.question)
